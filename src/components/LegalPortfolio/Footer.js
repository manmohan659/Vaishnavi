...
import { ArrowUp, MapPin, Clock, Mail, Phone } from 'lucide-react';
        ...
        <div className="grid grid-cols-12 gap-y-12 gap-x-6 md:gap-x-8">
          ...
          >
            ...
            <div className="mt-8 flex space-x-5">
              {/* Social icons - placeholder/example */}
              {['linkedin', 'twitter', 'email'].map((social, i) => (
                ...
                >
                  <span className="text-xs uppercase tracking-wider">{social[0].toUpperCase()}</span>
                </a>
              ))}
            </div>
          </div>
          ...
          >
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center text-silver">
                ...
                <a href="mailto:contact@vaishnavi.legal" className="hover:text-emerald-light transition-colors">
                  contact@vaishnavi.legal
                </a>
              </li>
              <li className="flex items-center text-silver">
                <Phone className="mr-3 text-emerald flex-shrink-0" size={18} />
                <a href="tel:+12125551234" className="hover:text-emerald-light transition-colors">
                  +1 (212) 555-1234
                </a>
              </li>
            </ul>
